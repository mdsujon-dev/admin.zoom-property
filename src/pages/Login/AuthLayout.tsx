...
export function AuthLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col bg-secondary-50 lg:flex-row">
      ...
      <aside className="relative hidden overflow-hidden bg-gradient-to-br from-[#0f2740] via-[#133050] to-[#133050] lg:flex lg:min-h-screen lg:w-[46%] xl:w-1/2">
        ...
        <motion.div
          aria-hidden
          className="pointer-events-none absolute -left-24 top-16 h-80 w-80 rounded-full bg-[#2867a0]/40 blur-3xl"
      ...
      <style>{`
        ...
        .auth-form .ant-input-affix-wrapper-focused { border-color: #133050 !important; }
